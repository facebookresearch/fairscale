...
# Adapted from https://github.com/pytorch/fairseq/blob/master/fairseq/optim/dynamic_loss_scaler.py
...
class DynamicLossScaler(object):
    def __init__(
        ...
        self.multiply_factor = 1.0 / float(self.loss_scale)

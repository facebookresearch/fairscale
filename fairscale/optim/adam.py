...
try:
    apex: Any = importlib.import_module("apex")
    multi_tensor_applier = apex.multi_tensor_apply.multi_tensor_applier
    FusedAdam: Any = apex.optimizers.fused_adam.FusedAdam

...
def run_ddp_parity(
    ...
    def check_parity(manual_reduction: bool):
        ...
        for i in range(NUMBER_BATCHS):
            ...
            # This is not ShardeDDP specific. If the grads are not NaN for DDP then they should also
...
def test_ddp_parity(reduce_buffer_size, grad_accumulation, change_train_graph, clip_grad_norm, amp, backend):

...
def run_test_parallel_embedding(rank, model_parallel_size, filename, filename_rpc, filename_mpi):
...
def run_test_initialize_affine_weight(rank, model_parallel_size, filename, filename_rpc, filename_mpi):
    dist_init(rank, model_parallel_size, filename, filename_rpc, filename_mpi)
...
def run_test_column_parallel_linear(rank, model_parallel_size, filename, filename_rpc, filename_mpi):
    dist_init(rank, model_parallel_size, filename, filename_rpc, filename_mpi)
...
def run_test_row_parallel_linear(rank, model_parallel_size, filename, filename_rpc, filename_mpi):
    dist_init(rank, model_parallel_size, filename, filename_rpc, filename_mpi)
...
def run_test_pipe(rank, world_size, filename, filename_rpc, filename_mpi, skip_dist_init=False):
    pipe_world_size = 2
    ...
    if not skip_dist_init:
        dist_init(rank, world_size, filename, filename_rpc, filename_mpi)
    else:
